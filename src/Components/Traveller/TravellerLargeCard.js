...
function TravellerLargeCard() {
    return (
        <div className="largecard">
            <div className="largecarditself">
                <h2 className="largecardheadertext">Some text</h2>
                <p>
                ...
                <button className="largecardbutton"> Learn More </button>
            </div>
        </div>
    )
}

export default TravellerLargeCard
